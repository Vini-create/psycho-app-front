...
/**
 * O handler é registrado pelo SessionProvider, que é quem conhece o router.
 * O client em si não pode importar navegação — ele roda em teste também.
 */
...
export const appApi = appEndpoints(api);
